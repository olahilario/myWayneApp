...
function About({isLogged, setIsLogged}) {
  ...
  return (
    <div className={styles.background_about}>
      ...
      É possível que AppWayne apareça na documentação, já que seria o novo nome da aplicação. Mas como chama atenção o próprio Batman: "Gothan City ficou desprotegida por 3 dias por uma besteira de nome que eu não conseguia lembrar".
